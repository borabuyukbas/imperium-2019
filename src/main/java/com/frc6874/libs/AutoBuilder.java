...
import com.frc6874.robot2019.Robot;
 ...
 */
public class AutoBuilder<T> extends Thread {

  /**
   * Constructor to build a new AutoBuilder. This should always be the first step of using AutoBuilder.
   * Use this method if your motor controllers are setup as master/slaves.
   * Usage: AutoBuilder<Spark> ckAuto = new AutoBuilder<Spark>(mySpark1, mySpark2, this);
   ...
   * @throws Exception
   */
  public AutoBuilder(T leftDrive, T rightDrive, Robot robot) throws Exception {
  ...
  /**
   * Constructor to build a new AutoBuilder. This should always be the first step of using AutoBuilder.
   * Usage: AutoBuilder<Spark> ckAuto = new AutoBuilder<Spark>(mySpark1, mySpark2, mySpark3, mySpark4, this);
   ...
   * @throws Exception
   */
  public AutoBuilder(T leftDrive1, T leftDrive2, T rightDrive1, T rightDrive2, Robot robot) throws Exception {
  ...
  /**
   * Constructor to build a new AutoBuilder. This should always be the first step of using AutoBuilder.
   * Usage: AutoBuilder<Spark> ckAuto = new AutoBuilder<Spark>(mySpark1, mySpark2, mySpark3, mySpark4, mySpark5, mySpark6, this);
   * @param leftDrive1 The first left drive motor controller.
   * @param leftDrive2 The second left drive motor controller.
   ...
   * @throws Exception
   */
  public AutoBuilder(T leftDrive1, T leftDrive2, T leftDrive3, T rightDrive1, T rightDrive2, T rightDrive3, Robot robot) throws Exception {
   ...
   * Usage Delay: ckAuto.addAutoStep(0, 0, 2000); //This will add a 2 second delay in the sequence of action, no matter what drive mode is active.
